...
public class MutipleLineOrderPage extends BaseTest {
	...
	public void getAddMultipleItems()  {
		LogUtil.info("Start getAddMultipleItems method");
		...
		LogUtil.info("end getAddMultipleItems method");
	}
